...
def main():
    print("--- BASELINE: FCOREF (biu-nlp/f-coref) ---")

    # Load the FCoref coreference model (downloads automatically on first run)
    # FCoref is a faster and lighter alternative to LingMess
